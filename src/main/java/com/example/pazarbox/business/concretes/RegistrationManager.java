...
import com.example.pazarbox.core.utillities.validation.ValidationService;
import com.example.pazarbox.core.utillities.verification.MailVerificationSenderManager;
import com.example.pazarbox.core.utillities.verification.MailVerificationSenderService;
...
public class RegistrationManager implements RegistrationService {
    ...
    private final MailVerificationSenderService mailVerificationSenderService;


    @Override
    public Result register(RegistrationRequest request) {
        this.validationService.isValid(request.getEmail());
        this.validationService.takenEmail(request.getEmail());
        ...
        mailVerificationSenderService.send(
                request.getEmail (),
                buildEmail (request.getFirstName(),link));

        return new SuccessResult("Successfully,Your account created please check your Inbox!");
